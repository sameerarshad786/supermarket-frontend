...
const CartItem = ({ product, accessToken }) => {
  const [onCart, setOnCart] = useState(product.on_cart);
        ...
        <div className="cart-item-detail">
          ...
          <span>
            <p className="product-price">
              {product.price.lower} $
              {product.price.upper !== null && ` to ${product.price.upper} $`}
            </p>
          </span>
      ...
      {onCart ? (
        ...
        >
          <svg
            ...
            width="20"
          >
            <path d="M464-596v-132H332v-32h132v-132h32v132h132v32H496v132h-32ZM276.095-131.384q-22.095 0-36.941-15.059-14.847-15.059-14.847-37.154 0-22.095 15.059-36.941 15.059-14.847 37.154-14.847 22.095 0 36.942 15.059 14.846 15.059 14.846 37.154 0 22.095-15.059 36.941-15.058 14.847-37.154 14.847Zm407.385 0q-22.095 0-36.942-15.059-14.846-15.059-14.846-37.154 0-22.095 15.059-36.941 15.058-14.847 37.154-14.847 22.095 0 36.941 15.059 14.847 15.059 14.847 37.154 0 22.095-15.059 36.941-15.059 14.847-37.154 14.847ZM88-812v-32h99.923l148.846 344.615h286.385q6.923 0 12.308-3.461 5.384-3.462 9.23-9.615L741.539-748h32.615L673.769-500.615Q667.077-486 654.16-476.692q-12.917 9.308-29.468 9.308H317l-46.615 81.23q-6.154 9.231-.385 20t17.308 10.769h448.385v32.001H288.308q-32 0-46.847-26.885-14.846-26.885.77-51.885l58.153-99.231L166.307-812H88Z" />
          </svg>
        </button>
      )}
